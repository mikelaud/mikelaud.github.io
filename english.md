...
#### Теория
Построение времени
- **вспомогательный глагол** - передает время, не переводится
- **+**
- **смысловой глагол** - показывает действие
  
Три времени
- Present <sub><sup>**настоящее**: данный момент или текущая реальность</sup></sub>
- Past <sub><sup>**прошлое**: момент в прошлом</sup></sub>
- Future <sub><sup>**будущее**: момент в будущем</sup></sub>

Четыре смысловых акцента времени
- Simple
- Continuous
- Perfect
- Perfect Continuous
